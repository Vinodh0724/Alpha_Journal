...
class UpdateHealthEntryScreen extends StatefulWidget {
  final String documentId;
  final String initialTitle;
  final String initialHealthProblem;
  final String initialMedicineName;
  final String initialDescription;
  final String initialHealthGoals;
  ...
  const UpdateHealthEntryScreen({
    ...
    required this.initialHealthGoals,
    this.initialDate,
...
class _UpdateHealthEntryScreenState extends State<UpdateHealthEntryScreen> {
  ...
  void initState() {
    ...
    _healthProblemController.text = widget.initialHealthProblem;
    _medicineNameController.text = widget.initialMedicineName;
    _descriptionController.text = widget.initialDescription;
    _healthGoalsController.text = widget.initialHealthGoals;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Update Health Entry'),
        actions: [
          IconButton(
