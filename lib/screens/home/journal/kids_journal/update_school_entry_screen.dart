...
class UpdateSchoolEntryScreen extends StatefulWidget {
  ...
  const UpdateSchoolEntryScreen({
    super.key,
    required this.documentId,
    required this.initialTitle,
    required this.initialDescription,
    required this.initialImages,
    required this.isImportant, required initialReflection, required initialAchievements,
  });

  @override
  _UpdateSchoolEntryScreenState createState() => _UpdateSchoolEntryScreenState();
}

class _UpdateSchoolEntryScreenState extends State<UpdateSchoolEntryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Update School Entry'),
      ),
      body: Padding(
